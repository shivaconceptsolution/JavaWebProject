 ...
 * @author Hp
 */
public class EmploginSer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
         ...
         PrintWriter out = response.getWriter();
          ...
          ResultSet x = st.executeQuery("select * from emp where empid='"+request.getParameter("txtempid")+"' and password ='"+request.getParameter("txtemppass")+"'");
          if(x.next())
            response.sendRedirect("dashboard.jsp?q="+request.getParameter("txtempid"));
          else
